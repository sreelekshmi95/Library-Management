...
<body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="offset-md-4 col-md-4">
                    ...
                    <div class="logo" >
                        <a href="#"><img src="{{ asset('images/library2.png') }}" ></a>
                        <!-- <h2 style="color:red;font-weight:bold">Library  management system</h2> -->
    ...
    <div id="footer">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <span>© Copyright 2023 <a href="#">Library project</a></span>
                </div>
            </div>
        </div>
    </div>
